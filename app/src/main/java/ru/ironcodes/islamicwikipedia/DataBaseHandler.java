...
public class  DataBaseHandler extends SQLiteOpenHelper {
    ...
    public Azkar getAzkar(int id) {
        ...
        Cursor cursor = db.rawQuery("SELECT azkartable._id, azkartable.subcat_name, azkartable.azkarfield, azkartable.category_name, subcategory.file_name,fav FROM azkartable,subcategory WHERE subcategory.name = azkartable.subcat_name AND " + KEY_ID + "= " + id, null);
        try {
            if (cursor != null && cursor.moveToFirst()) {

                Azkar azkar = new Azkar(Integer.parseInt(cursor.getString(0)), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5));
                return azkar;
            }
        } finally {
            cursor.close();
    ...
    public List<Azkar> getAllSubCat(CharSequence value) {
        ...
        // Select All Query
        String selectQuery = "SELECT name,file_name, COUNT(subcat_name ) AS count FROM subcategory LEFT JOIN azkartable ON name = subcat_name WHERE name LIKE '%" + value + "%'  GROUP BY name ORDER BY  name ASC";
    ...
    public List<Azkar> getAzkarByCategory(String value) {
        List<Azkar> azkarList = new ArrayList<Azkar>();
        // Select All Query
        String selectQuery = "SELECT azkartable._id, azkartable.subcat_name, azkartable.azkarfield, azkartable.category_name,fav, subcategory.file_name  FROM azkartable,subcategory where subcategory.name = azkartable.subcat_name AND category_name = '" + value + "' ORDER BY azkartable.azkarfield ";
    ...
    public List<Azkar> getAzkarBySubcat(String value) {
        List<Azkar> azkarList = new ArrayList<Azkar>();
        // Select All Query
        String selectQuery = "SELECT azkartable._id, azkartable.subcat_name, azkartable.azkarfield, azkartable.category_name,fav, subcategory.file_name  FROM azkartable,subcategory where subcategory.name = azkartable.subcat_name AND name= '" + value + "' ORDER BY subcat_name";
    ...
    public int updateAzkar(Azkar azkar) {
        ...
        // updating row
        return db.update(TABLE_AZKAR, values, KEY_ID + " = ?", new String[]{String.valueOf(azkar.getID())});
