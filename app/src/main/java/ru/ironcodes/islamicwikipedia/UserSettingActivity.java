...
public class UserSettingActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(UserSettingActivity.this);
        ...
        if (summary != 0) {
            mytime.setSummary(DateFormat.getTimeFormat(getBaseContext()).format(summary));
        } else {
            mytime.setSummary("");
        }
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DIALOG_ID:
                ...
                if (summary != 0) {
                    c.setTimeInMillis(sharedPrefs.getLong("userTime", System.currentTimeMillis()));
                }
                hour = c.get(Calendar.HOUR_OF_DAY);
                minute = c.get(Calendar.MINUTE);
                TimePickerDialog tpk = new TimePickerDialog(this, timePickerListener, hour, minute, false);
